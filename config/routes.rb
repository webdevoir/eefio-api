Rails.application.routes.draw do
  defaults format: :json do
    ...
    get 'blocks/:id/raw', to: 'blocks#raw', as: :block_raw
    ...
    get 'blocks/:id/transactions', to: 'blocks#transactions', as: :block_transactions
    ...
    get 'blocks/:id/transactions/:index', to: 'blocks#transaction', as: :block_transaction
    ...
    get 'transactions/:id/raw', to: 'transactions#raw', as: :raw_transaction
  end
end
